...
final class SundayScheduler: @unchecked Sendable {
    private var timer: Timer?
    private var sendAction: (@Sendable () async -> Void)?

    func configure(enabled: Bool, sendTime: Date, action: @escaping @Sendable () async -> Void) {
